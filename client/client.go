...
// APIClient manages communication with the Xendit API API v2.0.0
// In most cases there should be only one, shared, APIClient.
type APIClient struct {
	cfg    *xendit.Configuration
...
func NewAPIClient(cfg *xendit.Configuration) *APIClient {
...
func (c *APIClient) GetConfig() *xendit.Configuration {
	return c.cfg
}
...
func (c *APIClient) PrepareRequest(
	...
	headerParams["xendit-lib-ver"] = "2.0.0"
	...
	if ctx != nil {
		...
		if auth, ok := ctx.Value(xendit.ContextBasicAuth).(xendit.BasicAuth); ok {
