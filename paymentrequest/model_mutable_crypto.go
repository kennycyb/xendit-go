...
type MutableCrypto struct {
	ChannelCode *CryptoChannelCode `json:"channel_code,omitempty"`
...
// SetChannelCode gets a reference to the given CryptoChannelCode and assigns it to the ChannelCode field.
