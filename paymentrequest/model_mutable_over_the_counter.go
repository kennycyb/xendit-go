...
func (o *MutableOverTheCounter) GetAmount() float32 {
...
func (o *MutableOverTheCounter) GetAmountOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MutableOverTheCounter) SetAmount(v float32) {
	o.Amount.Set(&v)
}
...
func (o *MutableOverTheCounter) GetCurrency() PaymentRequestCurrency {
...
func (o *MutableOverTheCounter) SetCurrency(v PaymentRequestCurrency) {
	o.Currency = &v
}
