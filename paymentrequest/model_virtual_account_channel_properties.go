...
type VirtualAccountChannelProperties struct {
	...
	SuggestedAmount *float32 `json:"suggested_amount,omitempty"`
}
...
func (o *VirtualAccountChannelProperties) GetSuggestedAmount() float32 {
...
// and a boolean to check if the value has been set.
func (o *VirtualAccountChannelProperties) GetSuggestedAmountOk() (*float32, bool) {
	if o == nil || utils.IsNil(o.SuggestedAmount) {
		return nil, false
	}
...
// SetSuggestedAmount gets a reference to the given float32 and assigns it to the SuggestedAmount field.
func (o *VirtualAccountChannelProperties) SetSuggestedAmount(v float32) {
	o.SuggestedAmount = &v
}
