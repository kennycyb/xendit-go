...
// checks if the MutableQRCode type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &MutableQRCode{}
...
func (v NullableMutableQRCode) Get() *MutableQRCode {
	return v.value
}
...
func NewNullableMutableQRCode(val *MutableQRCode) *NullableMutableQRCode {
	return &NullableMutableQRCode{value: val, isSet: true}
}
