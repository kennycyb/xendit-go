...
// checks if the PublicPaymentChannelAllOf type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &PublicPaymentChannelAllOf{}
...
func NewPublicPaymentChannelAllOf() *PublicPaymentChannelAllOf {
	this := PublicPaymentChannelAllOf{}
	return &this
}
...
type NullablePublicPaymentChannelAllOf struct {
	value *PublicPaymentChannelAllOf
	isSet bool
}

func (v NullablePublicPaymentChannelAllOf) Get() *PublicPaymentChannelAllOf {
	return v.value
}

func (v *NullablePublicPaymentChannelAllOf) Set(val *PublicPaymentChannelAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicPaymentChannelAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicPaymentChannelAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicPaymentChannelAllOf(val *PublicPaymentChannelAllOf) *NullablePublicPaymentChannelAllOf {
	return &NullablePublicPaymentChannelAllOf{value: val, isSet: true}
}
