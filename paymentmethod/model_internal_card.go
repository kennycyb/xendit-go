...
// checks if the InternalCard type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &InternalCard{}

// InternalCard Card Payment Method Details
...
func (o *InternalCard) SetCardVerificationResultsNil() {
...
func (o InternalCard) MarshalJSON() ([]byte, error) {
...
func (o InternalCard) ToMap() (map[string]interface{}, error) {
...
type NullableInternalCard struct {
	value *InternalCard
	isSet bool
}

func (v NullableInternalCard) Get() *InternalCard {
	return v.value
}

func (v *NullableInternalCard) Set(val *InternalCard) {
	v.value = val
	v.isSet = true
}

func (v NullableInternalCard) IsSet() bool {
	return v.isSet
}

func (v *NullableInternalCard) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInternalCard(val *InternalCard) *NullableInternalCard {
	return &NullableInternalCard{value: val, isSet: true}
}

func (v NullableInternalCard) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInternalCard) UnmarshalJSON(src []byte) error {
	v.isSet = true
